...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in execution_engine_pb2_grpc.py depends on'
...
def add_ExecutionEngineServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'gee.v1.ExecutionEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('gee.v1.ExecutionEngine', rpc_method_handlers)
